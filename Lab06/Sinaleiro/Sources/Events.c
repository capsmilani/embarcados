...
**     Date/Time   : 2017-04-04, 18:39, # CodeGen: 0
**     Abstract    :
...
#include "Cpu.h"
#include "Events.h"
extern unsigned char temporizador;			//variavel global importada do 'main.c'
...
void TI1_OnInterrupt(void){
  /* Write your code here ... */
	if(temporizador > 0){			//interrupção ocasionada a cada 100ms
		temporizador--;				//decrementa o contador por um tempo definido na maquina
	}
}
